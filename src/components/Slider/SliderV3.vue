  ...
  <div class="flex justify-center w-full">
    <div class="relative w-full h-[780px] sm:h-[730px] lg:h-[500px] overflow-hidden">
      ...
      >
        ...
        >
          <div
            class="h-72 lg:h-[500px] box-content flex items-center md:px-12 lg:px-6 xl:px-16"
          >
            <img class="object-cover h-full" :src="slide.thumbnailUrl" alt="image" />
          </div>

          <div
            class="flex flex-col justify-between h-full px-20 py-3 align-middle sm:px-40 lg:pl-0"
          >
            ...
            <a
              :href="createLink(slide.slug)"
              @click.prevent="$router.push('/articles/' + slide.slug)"
            ...
            <div class="">
              <p
                class="w-full mt-8 mb-12 text-sm text-justify text-gray-600 font-questrial clamp lg:text-base description"
              >
                {{ slide.content }}
              </p>
            </div>
