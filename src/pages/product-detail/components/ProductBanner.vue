...
<template>
  ...
  >
    ...
    <div class="items-center lg:flex text-center lg:text-left lg:ml-64">
      <h2 v-html="productName" class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-[5.5rem] font-questrial font-normal text-white max-w-[450px] xl:max-w-[50vw]" />
